...
namespace CpmPedidos.Repository
{
    public class ProdutoMap : BaseDomainMap<Produto>
    {
        ...
        public override void Configure(EntityTypeBuilder<Produto> builder)
        {
            ...
            builder.HasOne(x => x.CategoriaProduto).WithMany(x => x.Produtos).HasForeignKey(x => x.IdCategoria);
            ...
            builder.HasMany(x => x.Imagens)
                ...
                x =>
                {
                    ...
                    x.Property(f => f.IdImagem).HasColumnName("id_imagem").IsRequired();
                    x.Property(f => f.IdProduto).HasColumnName("id_produto").IsRequired();
                }
                );
